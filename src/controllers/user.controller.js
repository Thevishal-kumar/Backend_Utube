...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const isPasswordVliad = await user.isPasswordCorrect(password)
...
const updateUserAvatarImage = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user, "Avatar images updated successfully"))
})
    ...
    res.status(200)
        ...
        .json(
            new ApiResponse(200, user[0].watchedHistory,
                "Watched history fatched successfully"
            )
        )
})
